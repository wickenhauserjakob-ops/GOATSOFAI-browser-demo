# Browser Demo: Final-Phone Unified Variant AI 960

This folder packages the stopped-best 960 TFLite detector for browser inference.

- model: `model.tflite`
- source weights: `variant_unified_final_phone_all_original_960_from_baseline_sgd`
- input size: `960 x 960`
- audit status: deployment smoke only; training was stopped at user request before epoch 100
- output decoder: YOLOv8 raw output `[1, 104, 18900]`
...
```text
http://localhost:8000/browser_inference/final_phone_960_stopped_best/
```
