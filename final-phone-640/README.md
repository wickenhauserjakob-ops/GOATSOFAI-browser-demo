# Browser Demo: Final-Phone Unified Variant AI 640

This folder packages the final-phone 640 TFLite detector for browser inference.

- model: `model.tflite`
- source weights: `variant_unified_final_phone_all_original_640_from_baseline_sgd`
- input size: `640 x 640`
- audit status: deployment smoke only; old test images are included in training
- output decoder: YOLOv8 raw output `[1, 104, 8400]`
...
```text
http://localhost:8000/browser_inference/final_phone_640_all_original/
```
